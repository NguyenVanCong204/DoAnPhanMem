            ...
            <div className="home-header-container">
              <div className="home-header-content">
                ...
                <div className="center-content">
                  ...
                  <div className="child-content">
                    <div>
                      <b><FormattedMessage id="home-header.medicalfacility"/></b>
                    </div>
                    <div className="subs-title"><FormattedMessage id="home-header.hospitalclinic"/></div>
                  </div>
                  <div className="child-content">
                    <div>
                      <b><FormattedMessage id="home-header.doctor"/></b>
                    </div>
                    <div className="subs-title"><FormattedMessage id="home-header.gooddoctor"/></div>
                  </div>
                  <div className="child-content">
                    <div>
                      <b><FormattedMessage id="home-header.examinationpackage"/></b>
                    </div>
                    <div className="subs-title"><FormattedMessage id="home-header.generalhealthexamination"/></div>
                  </div>
                </div>
            ...
            <div className="home-header-container">
              <div className="home-header-banner">
                <div className="content-up">
                  <div className="title1"><FormattedMessage id="home-header.medicalfoundation"/></div>
                ...
                <div className="content-down">
                  <div className="options">
                    <div className="option-child">
                      ...
                      <div className="text-child"><FormattedMessage id="home-header.specializedexamination"/></div>
                    </div>
                    <div className="option-child">
                      <div className="icon-child">
                      <i class="fa-solid fa-mobile-screen-button"></i>
                      </div>
                      <div className="text-child"><FormattedMessage id="home-header.remoteexamination"/></div>
                    </div>
                    <div className="option-child">
                      <div className="icon-child">
                      <i class="fa-solid fa-bed-pulse"></i>
                      </div>
                      <div className="text-child"><FormattedMessage id="home-header.generalexamination"/></div>
                    </div>
                    <div className="option-child">
                      <div className="icon-child">
                    ...
                    <div className="option-child">
                      ...
                      <div className="text-child"><FormattedMessage id="home-header.dentalexamination"/></div>
                    </div>
                  </div>
                </div>
              </div>
