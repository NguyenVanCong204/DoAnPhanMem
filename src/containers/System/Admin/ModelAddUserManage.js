...
class ModelAddUserManage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      licenseFileName: "",
  ...
  render() {
    return (
      ...
      >
        ...
        >
          <div className="title-header">Thêm cán bộ</div>
        </ModalHeader>
        <ModalBody>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModelAddUserManage);
