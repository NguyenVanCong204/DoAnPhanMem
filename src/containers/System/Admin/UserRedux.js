          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 mb-5">
                <TableManageUser
                  handleEditUserFromParentKey={this.handleEditUserFromParent} //Truyền hàm edit sang cho tk con
                  actions={this.state.actions} //Để tk con hiểu dg ở actions nào -- chưa dùng đến #61
                />
              </div>
            </div>
          </div>
